                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div v-for="no in fotos.length" :class="`carousel-item ${(no == 1) ? 'active' : ''}`">
                                <img :src="`/storage/${fotos[no - 1].nama}`" class="d-block w-100" alt="...">
                            </div>
                        </div>
                ...
                <div class="col">
                    ...
                    <div class="container p-0 d-flex">
                        <div class="card ms-2" style="padding: .7rem;" v-for="skil in skills">
                            <img :src="`/storage/${skil.logo}`" alt="" style="width: 1.7rem;object-fit: cover;">
                        </div>
                    </div>
...
onMounted(() => {
    project.value = usePage().props.value.project[0];
    skills.value = usePage().props.value.skills[0];
    fotos.value = usePage().props.value.fotos[0];
